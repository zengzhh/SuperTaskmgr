...
typedef struct _SYSTEM_PROCESSES {
	...
	// 
	LARGE_INTEGER ReadOperationCount; //IO读取
	LARGE_INTEGER WriteOperationCount; //IO写入
	LARGE_INTEGER OtherOperationCount; //IO其他
	LARGE_INTEGER ReadTransferCount; //IO读取字节
	LARGE_INTEGER WriteTransferCount; //IO写入字节
	LARGE_INTEGER OtherTransferCount; //IO其他字节
